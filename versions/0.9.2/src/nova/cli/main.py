...
def cli_main():
    ...
    if args.command == 'install':
        ...
        run_nova(args.file, args.verbose)
    elif args.command == 'repl':
        start_repl()
    elif args.command == 'compile':
        compile_nova(args.file, args.output, args.format)
...
# 运行Nova程序
def run_nova(file_path, verbose=False):
    """
    运行Nova程序
...
# 编译Nova程序
def compile_nova(file_path, output_path=None, format='python'):
    """
    编译Nova程序
