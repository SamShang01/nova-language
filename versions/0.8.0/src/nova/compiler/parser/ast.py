...
class FunctionDefinition(Node):
    ...
    def __init__(self, line, column, name, params, return_type, body, decorators=None, is_async=False):
        super().__init__(line, column)
        self.name = name
        self.params = params
...
class GenericFunctionDefinition(FunctionDefinition):
    ...
    def __init__(self, line, column, name, type_params, params, return_type, body, where_clause=None, is_async=False):
        super().__init__(line, column, name, params, return_type, body, is_async=is_async)
