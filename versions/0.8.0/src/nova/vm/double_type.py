...
class Double:
    ...
    def __add__(self, other):
        if isinstance(other, Double):
            ...
            result = self._add(self.value, str(other))
            return Double(result)
    ...
    def __sub__(self, other):
        if isinstance(other, Double):
            ...
            result = self._subtract(self.value, str(other))
            return Double(result)
        return NotImplemented
    
    def __rsub__(self, other):
        if isinstance(other, (int, float)):
            result = self._subtract(str(other), self.value)
            return Double(result)
        return NotImplemented
    ...
    def __mul__(self, other):
        if isinstance(other, Double):
            ...
            result = self._multiply(self.value, str(other))
            return Double(result)
        return NotImplemented
    ...
    def __truediv__(self, other):
        if isinstance(other, Double):
            ...
            result = self._divide(self.value, str(other))
            return Double(result)
        return NotImplemented
    
    def __rtruediv__(self, other):
        if isinstance(other, (int, float)):
            result = self._divide(str(other), self.value)
            return Double(result)
        return NotImplemented
