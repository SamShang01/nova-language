...
if __version__ >= (0, 5, 0):
    builtin_print("Nova语言标准库 0.5.0 特性:")
    builtin_print("1. NovaFunction类 - Nova专用函数代理对象")
    builtin_print("2. 高级参数系统 - 支持位置、关键字、默认值、可变参数")
    builtin_print("3. ParameterDefinition AST节点")
    builtin_print("4. 改进的REPL多行模式")
    builtin_print("5. 完善的函数参数绑定")
